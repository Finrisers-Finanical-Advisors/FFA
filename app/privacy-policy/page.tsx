...
export const metadata: Metadata = {
  title: "Website Privacy Policy | Finrisers",
  description: "Finrisers' privacy policy explaining how we collect, use, and protect your data.",
}

export default function PrivacyPolicyPage() {
  return (
    <LegalPage title="Website Privacy Policy" updated="August 13, 2026">
      <p>
        This privacy policy applies between you, the User of this Website, and Finrisers, the owner and
        provider of this Website. Finrisers takes the privacy of your information very seriously. This
      ...
      <p>This privacy policy should be read alongside, and in addition to, our Terms and Conditions.</p>
      ...
      <ul>
        <li>
          <strong>Data</strong> &mdash; collectively all information that you submit to Finrisers via the
          Website. This definition incorporates, where applicable, the definitions provided in the Data
          Protection Laws;
        </li>
        <li>
          <strong>Cookies</strong> &mdash; a small text file placed on your computer by this Website when
        ...
        <li>
          <strong>Data Protection Laws</strong> &mdash; any applicable law relating to the processing of
          personal Data, including but not limited to the GDPR, and any national implementing and
          supplementary laws, regulations and secondary legislation;
        </li>
        <li>
          <strong>GDPR</strong> &mdash; the General Data Protection Regulation;
        </li>
        <li>
          <strong>Finrisers, we or us</strong> &mdash; Finrisers, whose registered office is at 5900
          Balcones Drive, Suite 5506, Austin, TX 78731, United States;
        </li>
        <li>
          <strong>UK and EU Cookie Law</strong> &mdash; the Privacy and Electronic Communications (EC
          Directive) Regulations 2003 as amended by the Privacy and Electronic Communications (EC
          Directive) (Amendment) Regulations 2011 &amp; the Privacy and Electronic Communications (EC
          Directive) (Amendment) Regulations 2018;
        </li>
        <li>
          <strong>User or you</strong> &mdash; any third party that accesses the Website and is not either
          (i) employed by Finrisers and acting in the course of their employment or (ii) engaged as a
          consultant or otherwise providing services to Finrisers and accessing the Website in connection
          with the provision of such services; and
        </li>
        <li>
          <strong>Website</strong> &mdash; the website that you are currently using,
          https://www.finrisers.com/, and any sub-domains of this site unless expressly excluded by their
      ...
      <p>
        This privacy policy applies only to the actions of Finrisers and Users with respect to this
      ...
      <p>
        For purposes of the applicable Data Protection Laws, Finrisers is the &ldquo;data controller&rdquo;.
        This means that Finrisers determines the purposes for which, and the manner in which, your Data is
        processed.
      </p>
      ...
      <p>Finrisers will collect your Data in a number of ways, for example:</p>
      <ul>
      ...
      <ul>
        ...
        <li>
          ...
          below, headed &ldquo;Cookies&rdquo;.
        </li>
      </ul>
      ...
      <p>
        ...
        by contacting us via this e-mail address: info@finrisers.com.
      </p>

      <h2>Data retention</h2>
      <p>
        Unless a longer retention period is required or permitted by law, we will only hold your Data on
      ...
      <ul>
        <li>
          <strong>Right to access</strong> &mdash; the right to request (i) copies of the information we
          hold about you at any time, or (ii) that we modify, update or delete such information. If we
          provide you with access to the information we hold about you, we will not charge you for this,
          unless your request is &ldquo;manifestly unfounded or excessive.&rdquo; Where we are legally
          permitted to do so, we may refuse your request. If we refuse your request, we will tell you the
          reasons why.
        </li>
        <li><strong>Right to correct</strong> &mdash; the right to have your Data rectified if it is inaccurate or incomplete.</li>
        <li><strong>Right to erase</strong> &mdash; the right to request that we delete or remove your Data from our systems.</li>
        <li><strong>Right to restrict our use of your Data</strong> &mdash; the right to &ldquo;block&rdquo; us from using your Data or limit the way in which we can use it.</li>
        <li><strong>Right to data portability</strong> &mdash; the right to request that we move, copy or transfer your Data.</li>
        <li><strong>Right to object</strong> &mdash; the right to object to our use of your Data including where we use it for our legitimate interests.</li>
      </ul>
      <p>
        ...
        us via this e-mail address: info@finrisers.com.
      </p>
      <p>
        If you are not satisfied with the way a complaint you make in relation to your Data is handled by
        us, you may be able to refer your complaint to your relevant data protection or consumer protection
        regulator.
      </p>
      <p>It is important that the Data we hold about you is accurate and current. Please keep us informed if your Data changes during the period for which we hold it.</p>
      ...
      <p>
        Finrisers may, from time to time, expand or reduce our business and this may involve the sale
        and/or the transfer of control of all or part of Finrisers. Data provided by Users will, where it
      ...
      <h2>Cookies</h2>
      <p>
        This Website may place and access certain Cookies on your computer. Finrisers uses Cookies to
        improve your experience of using the Website and to improve our range of services. Finrisers has
      ...
      <p>
        Before the Website places Cookies on your computer, you will be presented with a message requesting
        your consent to set those Cookies. By giving your consent to the placing of Cookies, you are
        enabling Finrisers to provide a better experience and service to you. You may, if you wish, deny
        consent to the placing of Cookies; however certain features of the Website may not function fully
        or as intended.
      </p>
        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              example, cookies that enable you to log into secure areas of our website or make use of
              e-billing services.
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>
              ...
              personalise our content for you and remember your preferences (for example, your choice of
              language or region).
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              have followed. We will use this information to make our website and the advertising displayed
      ...
      <p>
        This Agreement will be governed by and interpreted according to the law of the State of Texas,
        United States. All disputes arising under the Agreement will be subject to the exclusive
        jurisdiction of the courts of the State of Texas.
      </p>

      <h2>Changes to this privacy policy</h2>
      <p>
        Finrisers reserves the right to change this privacy policy as we may deem necessary from time to
        time or as may be required by law. Any changes will be immediately posted on the Website and you
        are deemed to have accepted the terms of the privacy policy on your first use of the Website
        following the alterations. You may contact Finrisers by email at info@finrisers.com.
      </p>
    </LegalPage>
  )
}
